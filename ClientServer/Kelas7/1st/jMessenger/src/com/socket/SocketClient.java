            ...
            try {
                ...
                if(msg.type.equals("message")){
                    ...
                    */
                    ...
                    if (splitStr[0].equals("A") || splitStr[0].equals("I")) {
                    ...
                    if (splitStr[0].equals("A")) {
                        int newX;
                        if (msg.sender.equals(ui.username)) {
                            newX = ui.jButton9.getBounds().x + 10;
                            if (newX + ui.jButton9.getWidth() <= screenWidth && 
                                newX + ui.jButton9.getWidth() <= ui.jButton10.getBounds().x) {
                                ui.jButton9.setBounds(newX, ui.jButton9.getBounds().y, ui.jButton9.getWidth(), ui.jButton9.getHeight());
                            }
                        } else {
                            newX = ui.jButton10.getBounds().x + 10;
                            if (newX + ui.jButton10.getWidth() <= screenWidth &&
                                newX > ui.jButton9.getBounds().x + ui.jButton9.getWidth()) {
                                ui.jButton10.setBounds(newX, ui.jButton10.getBounds().y, ui.jButton10.getWidth(), ui.jButton10.getHeight());
                            }
                        }
                    }
                    ...
                    if (splitStr[0].equals("I")) {
                        ...
                        if (msg.sender.equals(ui.username)) {
                            newX = ui.jButton9.getBounds().x - 10;
                            if (newX >= 0 && newX + ui.jButton9.getWidth() <= ui.jButton10.getBounds().x) {
                                ui.jButton9.setBounds(newX, ui.jButton9.getBounds().y, ui.jButton9.getWidth(), ui.jButton9.getHeight());
                            }
                        } else {
                            newX = ui.jButton10.getBounds().x - 10;
                            if (newX >= 0 && newX >= ui.jButton9.getBounds().x + ui.jButton9.getWidth()) {
                                ui.jButton10.setBounds(newX, ui.jButton10.getBounds().y, ui.jButton10.getWidth(), ui.jButton10.getHeight());
                            }
                        }
                    }
